...
md"Define the function for the area of the n-Eck. Note, that we do not need to divide n*sn by halfe. $\pi$ is actually the area of the whole unit circle, not of half of it..."
